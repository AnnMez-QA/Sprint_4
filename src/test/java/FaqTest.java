...
public class FaqTest {
    ...
    public FaqTest (int questionIndex, String answerValue) {
    ...
    public void faqTest () {
        ...
        objMainPage.getClickOnQuestion(questionIndex);
        String actualAnswer = objMainPage.getTextOfAnswer(answerValue);
        assertEquals(answerValue, actualAnswer);
